...
public class Goomba extends Enemy {
	...
	public Goomba(Image enemyImage, int width, int height, int lives, int count,
			int columns, int offsetX, int offsetY, Point2D gravity, int x, int y, ArrayList<Block> gamePlatforms,
